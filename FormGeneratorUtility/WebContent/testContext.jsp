...
<body>
	...
	<a  class='text-decoration:none; glyphicon glyphicon-question-sign btn-lg'
	   href="#" title="Dismissible popover" data-toggle="popover"  data-placement="left" data-trigger="focus" data-content="Click anywhere in the document to close this popover"
	  	style='text-decoration:none; position:absolute;  top:0; right:0; margin: 10px 20px; color: black;'></a>
	<div class="container">
		<center>
			<h2>testContext</h2>
		</center>
		<form action="../insertForm/testContext" id="idtestContext"
			class="form-horizontal" method="post">
			<div class="form-group">
				<label class="control-label col-sm-4">code</label>
				<div class="col-sm-5">
					<input type="text" class="form-control" name="code" id="code"
						tabindex="12" maxlength="5" data-rule="required|Aplha_numeric" />
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-5">
					<input type="submit" class="btn btn-success" id="submittestContext"
						value="Submit" />
				</div>
			</div>
		</form>
		<textarea class='form-control'>This is context demo form 1111</textarea>
...
<script>
	$(function() {
		$('#submittestContext').click(function() {
...
<script>
	new Validator(document.querySelector('#idtestContext'), function(err, res) {
		return res;
	}, options = {
		rules : {
