    ...
    m.prototype = {
        messages: {
            en: {
                ...
                fieldLabel: {
                	empty: "Please, enter the Field Label",
                	incorrect: "Special characters not allow"
                },
                fieldName: {
                	empty: "Please, enter the Field Name",
                	incorrect: "Special characters and space not allow"
                },
                fieldSize: {
                	empty: "Please, enter the Field Size",
                	incorrect: "Special characters, Alphabets, Space not allow"
                },
                pageName: {
                	empty: "Please, enter the Page Name / Table Name",
                	incorrect: "Special characters and space not allow."
                },
                aplhaNumeric: {
                ...
                digitOnly: {
                	empty: "Please enter only digits",
                	incorrect: "Only digit allow"
                },
                onlyAplha: {
                	empty: "Only alphabetical allow",
                	incorrect: "Only alphabetical allow"
                },
                capitalOnly: {
                	empty: "Only capital alphabet letters allow",
                	incorrect: "Only capital alphabet lette allow"
                },
                smallOnly: {
                ...
                regex: {
                	empty: "Please select validation",
                	incorrect: "Please select validation"
                }
            }
        },
        rules: {
            ...
            fieldLabel: function(a) {
            	return (new RegExp(/^[A-Za-z0-9]{1}[A-Za-z0-9\s]{0,}$/g)).test(a)
            },
            fieldName: function(a) {
            	return (new RegExp(/^[A-Za-z_]{1}[A-Za-z0-9_]{0,}$/g)).test(a)
            },
            fieldSize: function(a) {
            	return (new RegExp(/^[1-9]{1}[0-9]{0,}([,][0-9])?$/g)).test(a)
            },
            pageName: function(a) {
            	return (new RegExp(/^[A-Za-z0-9]{1}[A-Za-z0-9_]{0,}$/g)).test(a)
            },
            aplhaNumeric: function(a) {
            	return (new RegExp(/^[A-Za-z0-9]{1}[A-Za-z0-9\s]{0,}$/g)).test(a)
            },
            password: function(a) {
            	return (new RegExp(/(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z].*[A-Z])(?=.*[@#$%^&+=].*[@#$%^&+=])(?=\S+$).{8,}/g)).test(a)
            },
            digitOnly: function(a) {
            	return (new RegExp(/^[1-9]{1,}[0-9]{0,}$/g)).test(a)
            },
            onlyAplha: function(a) {
            	return (new RegExp(/^[A-Za-z]{0,}/g)).test(a)
            },
            capitalOnly: function(a) {
            	return (new RegExp(/[A-Z]{0,}/g)).test(a)
            },
            smallOnly: function(a) {
            	return (new RegExp(/[a-z]/g)).test(a)
            },
            regex: function(a) {
        ...
        _eventChange: function(a) {
            ...
            if ("radio" === a.target.type) {
                var c = this.orderFields("id", a.target.name);
                ...
                c[a].rules && Object.keys(c[a].rules).forEach(function(m) {
                    ...
                    switch (c[a].handle.type) {
                        case "checkbox":
                            ...
                            break;
                        case "radio":
                            var n = b.orderFields("id", c[a].handle.name),
                                p = !1;
        ...
        showErrors: function(a) {
            ...
            Object.keys(this.errors).forEach(function(c) {
                a ? Object.keys(b.fields).forEach(function(e) {
                    b.fields[e].handle.getAttribute("id") === a.getAttribute("id") && d(b.fields[e].handle, b.errors[c])
